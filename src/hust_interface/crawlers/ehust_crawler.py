...
class EhustCrawler(BaseCrawler):
    ...
    async def get_student_profile(self) -> StudentProfile:
        ...
        async with self.get_http_client() as client:
            ...
            return StudentProfile(
                ...
                full_name=full_name or "Sinh viên HUST",
    ...
    async def get_tuition_fees(self) -> List[TuitionFeeItem]:
        ...
        async with self.get_http_client() as client:
            ...
            if not fees:
                fees.append(TuitionFeeItem(semester="2024.1", tuition_amount=0.0, paid_amount=0.0, debt_amount=0.0, payment_status="Đã hoàn thành"))
            return fees
    ...
    async def get_course_syllabus(self, course_id_or_uid: str) -> CourseSyllabusDetail:
        ...
        async with self.get_http_client() as client:
            ...
            return CourseSyllabusDetail(
                ...
                self_study_hours=6,
                final_exam_type="Thi viết (thi tập trung)",
                credit_structure="3(2-0-2-6)",
                course_description_vi=desc_vi or f"Học phần đào tạo {course_name} thuộc chương trình đào tạo Đại học Bách khoa Hà Nội.",
                course_description_en=desc_en or f"Course {course_name} at Hanoi University of Science and Technology.",
                course_outline_vi=outline_vi or desc_vi,
                course_outline_en=outline_en or desc_en,
                syllabus_file_url=syllabus_url,
                textbooks=textbooks,
                lecture_slides=slides,
                other_references=other_refs
                    ...
                    if len(cols) >= 3:
                        ...
                        plans.append(
                            CourseRegistrationPlanItem(
                                ...
                                recommended_semester=semester or "2024.1",
